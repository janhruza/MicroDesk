...
public partial class App : Application
{
    ...
    private void Application_Startup(object sender, StartupEventArgs e)
    {
        ...
        _ = _trayIcon.ContextMenuStrip.Items.Add("New Record", null, (s, args) =>
        {
            // show the main window
            if (MainWindow == null || !MainWindow.IsVisible)
            {
                MainWindow = new MoodTracker.MainWindow();
                _ = MainWindow.SetActivePage(MoodPage);
                MainWindow.Show();
            }
            else
            {
        ...
        _ = _trayIcon.ContextMenuStrip.Items.Add("Mood History", null, (s, args) =>
        {
            // show the mood history page
            if (MainWindow == null || !MainWindow.IsVisible)
            {
                MainWindow = new MoodTracker.MainWindow();
                _ = MainWindow.SetActivePage(MoodHistoryPage);
                MainWindow.Show();
            }
            else
            {
        ...
        _ = _trayIcon.ContextMenuStrip.Items.Add(new ToolStripSeparator());

        _ = _trayIcon.ContextMenuStrip.Items.Add("Settings", null, (s, args) =>
        {
            // show the settings window
            LibMicroDesk.MDCore.SettingsBox();
        });

        _ = _trayIcon.ContextMenuStrip.Items.Add("About MicroDesk", null, (s, args) =>
        {
        ...
        _ = _trayIcon.ContextMenuStrip.Items.Add("Exit", null, (s, args) =>
        {
